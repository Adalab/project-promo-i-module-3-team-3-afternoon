        ...
        return (
            <div className="containerShareTop">
                <div className="subContainer">
                    <div><i className="icon fas fa-share-alt" /></div>
                    <p className="title">COMPARTE</p>
                </div>
                <div className="iconDirection"><i className="iconDirection3 fas fa-chevron-down" /></div>
            </div>
            <div className="containerShareBottom">
                ...
                <button id="buttonValidation" className="button buttonShare" type="button" disabled>
                    <i className="iconSend far fa-address-card" />
                ...
                <div className="card__share hidden" id="card-share">
                    ...
                    <a id="twitter-share" href="" target="_blank">
                        <div className="btn-twitter"><i className="fab fa-twitter" />Compartir en twitter</div>
                    </a>
                </div>
            </div>
